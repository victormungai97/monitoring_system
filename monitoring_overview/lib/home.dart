...
import 'package:monitoring_overview/platform/platform.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Container(
                child: ListTile(
                  title: Text('Patient Camera'),
                  leading: Icon(Icons.video_call),
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (_) => WebviewWidget(mainURL)),
                    );
                  },
                  subtitle: Text('Click to view feed'),
                ),
